var g_vieweeId = null; // should ONLY be used in profile's page

function onPagerButtonClicked(evt) {
	var button = evt.data;
	var targetPage = button.page;
	var container = button.container;
	if(targetPage == container.page) return;
	var direction = targetPage > container.page ? g_directionForward : g_directionBackward;
	var refIndex = targetPage > container.page ? container.ed : container.st;
