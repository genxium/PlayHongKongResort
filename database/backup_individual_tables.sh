mysqldump -uroot -d hongkongresort activity>create_table_activity.sql
mysqldump -uroot -d hongkongresort activity_image_relation>create_table_activity_image_relation.sql
mysqldump -uroot -d hongkongresort assessment>create_table_assessment.sql
mysqldump -uroot -d hongkongresort comment>create_table_comment.sql
