...
public class SQLBuilder {
	...
	protected String appendJoin(String query) {
		...
		for (Map.Entry<String, List<OnCondition>> entry : join.entrySet()) {
			String secondaryTable = entry.getKey();
			...
			query += (" JOIN `" + secondaryTable + "` AS `" + tableAlias + "` ON ");
