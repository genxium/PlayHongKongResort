...
INSERT INTO `Image` VALUES (0,'/Users/user/play-2.2.0/PlayHelloWorld/uploaded_images/default_avatar.png');
...
CREATE TABLE `user` (
  ...
  KEY `FK_UserAvatar` (`UserAvatar`),
  CONSTRAINT `User_ibfk_1` FOREIGN KEY (`UserGroupId`) REFERENCES `UserGroup` (`GroupId`),
  CONSTRAINT `FK_UserAvatar` FOREIGN KEY (`UserAvatar`) REFERENCES `Image` (`ImageId`)
...
-- Dump completed on 2014-01-02  0:46:28
